...
\captionof{figure}{\textit{A table summarizing the visualization techniques used in each paper. The papers are ordered corresponding to the order in which they appear in the survey.}}\label{table}
\end{figure*}
